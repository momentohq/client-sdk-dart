...
class PubsubClient extends $grpc.Client {
  ...
  static final _$subscribe = $grpc.ClientMethod<$2.SubscriptionRequest_, $2.SubscriptionItem_>(
      '/cache_client.pubsub.Pubsub/Subscribe',
      ($2.SubscriptionRequest_ value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $2.SubscriptionItem_.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$2.Empty_> publish($2.PublishRequest_ request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$publish, request, options: options);
  }

  $grpc.ResponseStream<$2.SubscriptionItem_> subscribe($2.SubscriptionRequest_ request, {$grpc.CallOptions? options}) {
...
abstract class PubsubServiceBase extends $grpc.Service {
  ...
  PubsubServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$2.SubscriptionRequest_, $2.SubscriptionItem_>(
        'Subscribe',
        subscribe_Pre,
        false,
        true,
        ($core.List<$core.int> value) => $2.SubscriptionRequest_.fromBuffer(value),
        ($2.SubscriptionItem_ value) => value.writeToBuffer()));
  }

  $async.Future<$2.Empty_> publish_Pre($grpc.ServiceCall call, $async.Future<$2.PublishRequest_> request) async {
    return publish(call, await request);
  }

  $async.Stream<$2.SubscriptionItem_> subscribe_Pre($grpc.ServiceCall call, $async.Future<$2.SubscriptionRequest_> request) async* {
    yield* subscribe(call, await request);
  }

  $async.Future<$2.Empty_> publish($grpc.ServiceCall call, $2.PublishRequest_ request);
  $async.Stream<$2.SubscriptionItem_> subscribe($grpc.ServiceCall call, $2.SubscriptionRequest_ request);
}
